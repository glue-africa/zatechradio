  ...
  return (
    <>
      <SEO
        ...
        url={`/episodes/${slugify(episode.title)}`}
        type="article"
        image={episode.image || '/images/episode-default.jpg'}
      />
...
export async function getStaticProps({ params }) {
  ...
  let episode = myFeed.items
    .map(({ title, description, enclosures, published, created }) => ({
      id: created,
      title,
      published,
      description,
    ...
    .find((episode) => slugify(episode.title) === params.slug)
