...
import posterImage from '@/images/zatechradio_poster.jpg'
...
function BuyMeACoffeeIcon(props) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
function AboutSection(props) {
  ...
  return (
    <section {...props}>
      ...
      >
        ZATechRadio is a meeting place for the SA Tech community. We host
        conversations on topics affecting the everyday lives of techies in South
        Africa. Join us for this podcast and more.
      </p>
      {!isExpanded && (
        <button
          type="button"
...
export function Layout({ children }) {
  ...
  return (
    <>
      <header className="bg-slate-50 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-400 scrollbar-track-rounded-full scrollbar-thumb-rounded-full lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:w-112 lg:items-start lg:overflow-y-auto xl:w-120">
            ...
            >
              {[
                [
                  'Spotify',
                  SpotifyIcon,
                  'https://open.spotify.com/show/0SC8zgjrrO6ZuKZ2VBZ8QN?si=e1e35dbb53a543be',
                ],
                [
                  'Apple Podcasts',
                  ApplePodcastIcon,
                  'https://podcasts.apple.com/za/podcast/zatechradio/id1612482825',
                ],
                ['Discord', DiscordIcon, 'https://discord.gg/e2cDA5QeSV'],
                [
                  'Buy me a coffee',
                  BuyMeACoffeeIcon,
